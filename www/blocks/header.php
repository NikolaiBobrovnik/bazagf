...
<div class="container">
    <div class="header-bottom">
        <div class="header-bottom-logo">
            <a href="/"><img src="img/logo.png" alt="Логотип" title="База ГФ"></a>
        </div>
        <div class="header-bottom-banner1">
            <a href="#"><img src="img/banner1.png" alt="Баннер1" title="Баннер1"></a>
        </div>
        <div class="header-bottom-banner2">
            <a href="#"><img src="img/banner2.png" alt="Баннер2" title="Баннер2"></a>
        </div>
    </div>
</div>
