<div class="container">
  ...
  <div class="services-blocks">
    <div class="services-block">
      <div class="services-block-title">купить и продать</div>
      ...
      <div class="services-block-bottom"><a href="#" class="services-block-bottom-callme">Заказать звонок</a></div>
    </div>
    <div class="services-block">
        <div class="services-block-title">юридическое сопровождение</div>
        <div class="services-block-content">
    ...
    <div class="services-block">
        ...
        <div class="services-block-bottom">
          <a href="#" class="services-block-bottom-callme">Заказать звонок</a>
        </div>
    </div>
  </div>
</div>
